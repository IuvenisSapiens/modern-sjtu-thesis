...
#let preset-ziti = (
  ...
  heiti: ((name: "Times New Roman", covers: "latin-in-cjk"), "Heiti SC", "SimHei", "STHeiti", "Noto Sans CJK SC"),
  // 楷体
  // 这一行分别是「新罗马体（有衬线英文字体）」、「楷体（MacOS）」、「楷体（Windows）」、「华文楷体」、「方正楷体」
  kaiti: ((name: "Times New Roman", covers: "latin-in-cjk"), "Kaiti SC", "KaiTi", "STKaiti", "KaiTi_GB2312"),
  // 仿宋
